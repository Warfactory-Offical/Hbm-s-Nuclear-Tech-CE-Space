...
public class CrackingRecipesTweaker {
    ...
    public static void init() {
        ...
        cracking.put(com.hbmspace.inventory.fluid.Fluids.CHLOROETHANE,			new Tuple.Pair<>(new FluidStack(Fluids.POLYTHYLENE,	50),					new FluidStack(Fluids.CHLORINE,	30)));
        cracking.put(Fluids.ELBOWGREASE,			new Tuple.Pair<>(new FluidStack(Fluids.MERCURY,	70),						new FluidStack(Fluids.SOURGAS,	50)));
