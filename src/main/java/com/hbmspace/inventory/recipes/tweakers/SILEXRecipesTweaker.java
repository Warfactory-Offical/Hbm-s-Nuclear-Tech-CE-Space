...
public class SILEXRecipesTweaker {
    ...
    public static void init() {
        try {
            Field recipesField = SILEXRecipes.class.getDeclaredField("recipes");
            recipesField.setAccessible(true);

            @SuppressWarnings("unchecked")
            LinkedHashMap<Object, SILEXRecipes.SILEXRecipe> recipes =
                    (LinkedHashMap<Object, SILEXRecipes.SILEXRecipe>) recipesField.get(null);
            // TODO space waste types + add another crystal + stop forgetting to do things + implement space changes(!)
           ...
           /*recipes.put(new RecipesCommon.ComparableStack(ModItems.nuclear_waste_short, 1, ItemWasteShort.WasteClass.AMERICIUM241.ordinal()), new SILEXRecipes.SILEXRecipe(900, 100, 2)
            ...
            recipes.put(new RecipesCommon.ComparableStack(ModItems.nuclear_waste_short_depleted, 1, ItemWasteShort.WasteClass.AMERICIUM241.ordinal()), new SILEXRecipes.SILEXRecipe(900, 100, 2)
            ...
            /*recipes.put(new RecipesCommon.ComparableStack(ModItems.nuclear_waste_short, 1, ItemWasteShort.WasteClass.BERKELIUM247.ordinal()), new SILEXRecipes.SILEXRecipe(900, 100, 2)
            ...
            recipes.put(new RecipesCommon.ComparableStack(ModItems.nuclear_waste_short_depleted, 1, ItemWasteShort.WasteClass.BERKELIUM247.ordinal()), new SILEXRecipes.SILEXRecipe(900, 100, 2)
                    .addOut(new ItemStack(ModItemsSpace.nugget_cm_mix), 50)
            ...
            recipes.put(new RecipesCommon.ComparableStack(ModItems.nuclear_waste_short, 1, ItemWasteShort.WasteClass.CURIUM244.ordinal()), new SILEXRecipes.SILEXRecipe(900, 100, 2)
            ...
            recipes.put(new RecipesCommon.ComparableStack(ModItems.nuclear_waste_short_depleted, 1, ItemWasteShort.WasteClass.CURIUM244.ordinal()), new SILEXRecipes.SILEXRecipe(900, 100, 2)
            ...
            recipes.put(new RecipesCommon.ComparableStack(ModItems.nuclear_waste_short, 1, ItemWasteShort.WasteClass.CURIUM245.ordinal()), new SILEXRecipes.SILEXRecipe(900, 100, 2)
                    .addOut(new ItemStack(ModItemsSpace.nugget_cm246), 15)
                    .addOut(new ItemStack(ModItemsSpace.nugget_cm247), 10)
            ...
            recipes.put(new RecipesCommon.ComparableStack(ModItems.nuclear_waste_short_depleted, 1, ItemWasteShort.WasteClass.CURIUM245.ordinal()), new SILEXRecipes.SILEXRecipe(900, 100, 2)
