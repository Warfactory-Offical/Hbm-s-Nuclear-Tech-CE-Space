...
public class MagicRecipesTweaker {
    ...
    public static void init() {
        try {
            Field recipesField = MagicRecipes.class.getDeclaredField("recipes");
            recipesField.setAccessible(true);

            @SuppressWarnings("unchecked")
            List<MagicRecipes.MagicRecipe> recipes = (List<MagicRecipes.MagicRecipe>) recipesField.get(null);
