...
public class ModFluidsSpace {
    public static Fluid mercury_fluid = new MercuryFluid().setDensity(2500).setViscosity(2000).setTemperature(70+273);
    public static Fluid ccl_fluid = new CclFluid().setDensity(1840).setViscosity(1000).setTemperature(273);
